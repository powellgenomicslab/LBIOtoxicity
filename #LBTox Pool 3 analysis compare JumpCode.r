#LBTox Pool 3 analysis compare JumpCode
...
#Read RDS
LBtox3 <- readRDS("/directflow/SCCGGroupShare/projects/jenli3/LBTOX/SeuratObjects/LBtox3combined.RDS")
...
plot1 <- DimPlot(LBtox3, reduction="umap", label=TRUE)
ggsave(plot1, filename="Unlabelled LBtox3 UMAP pre QC.png", width = 8.5, height = 6.5)
...
LBtox3.preQC
saveRDS(LBtox3.preQC, file= "/directflow/SCCGGroupShare/projects/jenli3/LBTOX/JumpCode Analysis/LBtox3_PreQC_Annotated.RDS")
getwd()
...
ggsave(plot3, filename="LBTox3_PREQC_annotated.png",width = 8.5, height = 6.5)

#filtering
#QC with new parameters as per Joseph
LBtox3 <- subset(LBtox3.preQC, subset = nFeature_RNA>350 & percent.mt < 15)
LBtox3
Idents(object=LBtox3)
levels(x=LBtox3)

plot4 <- VlnPlot(LBtox3, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), idents=NULL, ncol = 3)
ggsave(plot4, filename="Violin Plot post QC LBtox3 Data.png", height = 4.5, width = 7.5)
...
ggsave(plot5, filename="LBtox3_postQC_annotated.png",width = 8.5, height = 6.5)
